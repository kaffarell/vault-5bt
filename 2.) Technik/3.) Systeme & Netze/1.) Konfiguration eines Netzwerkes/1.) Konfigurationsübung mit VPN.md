...
access-list 1 permit ip <abbr title="Lokales Netzwerk">192.168.X.0</abbr> <abbr title="Wildcard">0.0.0.255</abbr>
...
ancryption 3des
exit
crpto isakmp key 0 teststring address <abbr title="Adresse des Netzwerkes eines Kollegen">10.10.30.100</abbr>
```
